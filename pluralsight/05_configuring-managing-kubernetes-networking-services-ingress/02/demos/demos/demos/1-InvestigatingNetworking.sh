...
#Copy our SSH key into the container, off screen
...
ssh -i id_rsa azureuser@aks-nodepool1-13209943-vmss000000
...
#In Azure, these routes are implemented as route tables assigned to the virutal machine's for your Nodes.
