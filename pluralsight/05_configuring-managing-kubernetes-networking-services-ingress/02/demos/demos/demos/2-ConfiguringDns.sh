...
#On c1-master1, let's put the default configuration back, using . forward /etc/resolv.conf 
...
#TODO for the viewer...you can use this technique to verify your DNS forwarder configuration above.
...
ssh aen@c1-master1
kubectl run --generator=run-pod/v1 -it --rm debian --image=debian
...
#Here is some example output...www.pluralsight.com is goign to 1.1.1.1 and www.centinosystems.com is going to 9.9.9.9
